...
operations = {'ADD':add , 'ADDITION':add , 'SUM':add , '+':add ,
                'SUB':sub , 'DIFFERENCE':sub , 'MINUS':sub , '-':sub,
                 'LCM':lcm , 'HCF':hcf , 'PRODUCT':mul , '*':mul,
                 'MULTIPLY':mul , 'DIVISION':div , 'DIV':div ,'/':div, 'MOD':mod ,
...
l1 = Label(win , text='I am a smart calculator',width=22 , padx=5)
l1.place(x=150,y=10)
l2 = Label(win , text='My name is SAKRA' , padx=3)
l2.place(x=180,y=40)
